...
const editorClass = [
  ...
  "[&_pre]:mb-4 [&_pre]:overflow-x-auto [&_pre]:rounded-xs [&_pre]:border [&_pre]:border-rvl-line [&_pre]:bg-rvl-panel [&_pre]:p-3 [&_pre]:font-code [&_pre]:text-[0.88rem] [&_pre]:text-rvl-ink",
  "[&_code]:rounded-xs [&_code]:bg-rvl-panel [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-code [&_code]:text-[0.88em] [&_code]:text-rvl-ink",
