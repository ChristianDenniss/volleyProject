...
describe("authorization sweep", () => {
  ...
  const GUARDED_QUERIES: { procedure: string; access: "protected" | "admin" }[] = [
    ...
    { procedure: "articles.listAllPage", access: "admin" },
    { procedure: "articles.statusCounts", access: "admin" },
    { procedure: "articles.count", access: "admin" },
    { procedure: "games.listPage", access: "admin" },
    { procedure: "stats.listPage", access: "admin" },
    { procedure: "users.listPage", access: "admin" },
  ...
  it("guards every query the router exposes outside the public read surface", () => {
    const PUBLIC_QUERIES = new Set([
      ...
      "games.list",
      "games.listPlayed",
      "games.listPlayedPage",
      "games.listSchedule",
      "games.schedulePage",
      "games.scheduleFilters",
      "games.stages",
      "games.byId",
      "players.list",
      "players.listPage",
