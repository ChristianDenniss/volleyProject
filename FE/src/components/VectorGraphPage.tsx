...
function VectorGraph3D({
  ...
  const getArchetypeThresholds = (archetypeId: string): string => {
    const thresholds: Record<string, string> = {
      ...
      "tireless": "Spike attempts >8.5/set OR ape attempts >3.8/set OR assists >11.5/set",
      "workhorse": "Spike attempts >4.5/set OR ape attempts >1.8/set OR assists >7.5/set (but not Tireless)",
