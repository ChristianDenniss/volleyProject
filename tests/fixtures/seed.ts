...
export async function seed(db: Db): Promise<typeof FIXTURES> {
  ...
  await insertMany(db, teamsGames, [
    { gameId: 1, slot: 1, teamId: 1 },
    { gameId: 1, slot: 2, teamId: 2 },
    { gameId: 2, slot: 1, teamId: 1 },
    { gameId: 2, slot: 2, teamId: 3 },
    { gameId: 3, slot: 1, teamId: 3 },
    { gameId: 3, slot: 2, teamId: 4 },
    { gameId: 4, slot: 1, teamId: 2 },
    { gameId: 4, slot: 2, teamId: 4 },
    { gameId: 5, slot: 1, teamId: 3 },
    { gameId: 5, slot: 2, teamId: 4 },
  ]);
